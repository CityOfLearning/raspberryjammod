...
public class Python2MinecraftApi {
	...
	protected static void entityGetDirection(int id) {
		...
		if (e != null) {
			...
			Python2MinecraftApi.sendLine(new Vec3(x, y, z));
		}
	}
	...
	protected static void entityGetPitch(int id) {
		Entity e = Python2MinecraftApi.getServerEntityByID(id);
		if (e != null) {
			Python2MinecraftApi.sendLine(MathHelper.wrapAngleTo180_double(e.rotationPitch));
		}
	}
	...
	protected static void entityGetPos(int id) {
		...
		if (e != null) {
			...
			Vec3 pos = Location.encodeVec3(Python2MinecraftApi.serverWorlds, w, pos0);
	...
	protected static void entityGetRotation(int id) {
		Entity e = Python2MinecraftApi.getServerEntityByID(id);
		if (e != null) {
			Python2MinecraftApi.sendLine(MathHelper.wrapAngleTo180_double(e.rotationYaw));
		}
	}
	...
	protected static void entitySetDirection(int id, Scanner scan) {
		...
		e = Python2MinecraftApi.mc.theWorld.getEntityByID(id);
		if (e != null) {
			Python2MinecraftApi.entitySetDirection(e, x, y, z);
		}
	}
	...
	static boolean refresh() {
		if (!Python2MinecraftApi.useClientMethods) {
			Python2MinecraftApi.serverWorlds = FMLCommonHandler.instance().getMinecraftServerInstance().worldServers;
			...
			Python2MinecraftApi.serverWorlds = new World[] { Python2MinecraftApi.mc.theWorld };

			if (Python2MinecraftApi.mc.thePlayer == null) {
	...
	protected static void sendLine(Vec3 pos) {
		Python2MinecraftApi.sendLine("" + pos.xCoord + "," + pos.yCoord + "," + pos.zCoord);
	}
